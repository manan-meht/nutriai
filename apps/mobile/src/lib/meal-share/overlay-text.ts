// Mirrors the main web app's src/lib/meal-share/overlay-text.ts —
// duplicated here rather than shared, matching this app's existing
// duplication convention (see meal-share/types.ts's own comment). Keep in
// sync manually if the web app's overlay-text library changes.
//
