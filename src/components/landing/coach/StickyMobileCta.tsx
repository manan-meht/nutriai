...
export function StickyMobileCta({
  ...
  return (
    <div
      ...
      style={{ backgroundColor: "rgba(10,10,10,0.94)", borderColor: "rgba(74,68,85,0.6)", backdropFilter: "blur(8px)" }}
    ...
    >
      {/* The count sits above the button rather than inside it: a coach
          ...
          it has on a phone. */}
      {spotsRemaining != null && (
        <p className="mb-2 text-center text-[11px] font-medium" style={{ color: "#A1A1A1" }}>
