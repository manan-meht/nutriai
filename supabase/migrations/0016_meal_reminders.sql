...
alter table adults_contacts
  ...
  add column reminder_times jsonb not null default '["08:00", "12:00", "19:00"]'::jsonb;
...
create table meal_reminder_sends (
...
create unique index meal_reminder_sends_dedupe_idx
